...
\include{approval}  % Grad School Approval Page - approval.tex

\include{dedica}  % Dedication Page - dedica.tex

\include{ackno}  % Acknolwedgements Page - ackno.tex
...
\input{chp1-intro}  % Intoduction

\clearpage
\resetcounters

\input{chp2-data}  % Chapter 2

\clearpage
\resetcounters

\input{chp3-line_detection}  % Chapter 3

\clearpage
\resetcounters

\input{chp4-analysis}  % Chapter 4

\clearpage
\resetcounters

\input{chp5-MgII_absorb}  % Chapter 5

\clearpage
\resetcounters

\input{chp6-CIV_absorb}  % Chapter 6

\clearpage
\resetcounters

\input{chp7-kinematics}  % Chapter 7

\clearpage
\resetcounters

\input{chp8-conclusions}  % Chapter 8
...
\input{appendixA}  % Appendix A - appendixA.tex
